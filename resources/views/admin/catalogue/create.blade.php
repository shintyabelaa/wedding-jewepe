                            ...
                            <div class="auth-form-wrapper px-4 pt-2 pb-5">
                                <form action="{{ route('catalogues.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="package_name" class="form-control @error('package_name') is-invalid @enderror" id="package_name" value="{{ old('package_name') }}" placeholder="Enter Package Name">
                                        @error('package_name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group flatpickr" id="flatpickr-price">
                                            <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" placeholder="Select price" data-input value="{{ old('price') }}">
                                        </div>
                                        @error('price')
                                            <span class="tw-text-red-500 tw-text-xs">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" class="@error('description') is-invalid @enderror" name="description" id="description" rows="10">{{ old('description') }}</textarea>
                                        @error('description')
                                            <span class="tw-text-red-500 tw-text-xs">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="image" data-default-file="{{ old('image') }}" class="dropify @error('image') is-invalid @enderror" type="file" accept="image/*" id="image" />
                                        @error('image')
                                            <span class="tw-text-red-500 tw-text-xs">{{ $message }}</span>
                                        @enderror
                                    </div>
