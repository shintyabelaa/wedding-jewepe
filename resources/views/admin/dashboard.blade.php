        ...
        <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
            ...
            <div class="d-flex align-items-center flex-wrap text-nowrap">
                <div class="input-group flatpickr wd-200 mb-md-0 mb-2 me-2" id="dashboardDate">
                    <span class="input-group-text input-group-addon border-primary bg-transparent" data-toggle>
                        <i data-feather="calendar" class="text-primary"></i>
                    </span>
                    <input type="text" class="form-control border-primary bg-transparent" placeholder="Select date"
                        data-input />
                </div>
                <button type="button" class="btn btn-outline-primary btn-icon-text mb-md-0 mb-2 me-2">
                    <i class="btn-icon-prepend" data-feather="printer"></i>
                    Print
                </button>
                <button type="button" class="btn btn-primary btn-icon-text mb-md-0 mb-2">
                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="row align-items-start">
                            <div class="col-md-7">
                                <p class="text-muted tx-13 mb-md-0 mb-3">
                            ...
                            <div class="col-md-5 d-flex justify-content-md-end">
                                <div class="btn-group mb-md-0 mb-3" role="group" aria-label="Basic example">
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                <div>
                                    <label
                                        ...
                                        Total storage
                                        <span class="rounded-circle bg-secondary ms-1 p-1"></span>
                                    </label>
                            ...
                            <div class="col-6">
                                <div>
                                    <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder">
                                        <span class="rounded-circle bg-primary me-1 p-1"></span>
                                        Used storage
                                    </label>
